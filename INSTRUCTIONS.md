...
2. SSH into the VM
```
ssh [-i <path-to-private-key>] admin@<your-vm-ip-address>
```
3. Source env vars available at `/home/admin/app/env.sh`
4. `cd` into `/home/admin/app/` folder 
...
```
7. Run app on port 5000
```
uv run python manage.py runserver $ALLOWED_HOSTS:5000
```
8. Visit `<your.vm.dns>:5000/admin/` (do not forget the trailing slash)
...
```
Visit `http://<your.vm.dns>` in your browser - you should see the default NGINX welcome page.
